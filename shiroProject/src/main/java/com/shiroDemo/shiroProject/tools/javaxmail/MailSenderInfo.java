...
public class MailSenderInfo {
	 ...
	 */
	private String fromAddress = "846656938@qq.com";
	 ...
	 */
	private String userName = "846656938@qq.com";

	/**
	 * @FieldName password 登陆邮件发送服务器的密码
	 */
	private String password = "dgbqplhhlvsebdaj";
	...
	@Bean(name="mailSenderInfo")
	public MailSenderInfo isBean(){
